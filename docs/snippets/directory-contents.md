KIZUNANO COIN directory contains: wallets file (`wallets.ldb`), [log files](/running-a-node/troubleshooting/#log-files), optional config files, ledger file (data.ldb) and related lock files.
