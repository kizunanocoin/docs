Title: KIZUNANO COIN Protocol Design - Attack Vectors
...
|**Defense** | KIZUNANO COIN voting system is weighted based on account balance.  Adding extra nodes in to the network will not gain an attacker extra votes.  
